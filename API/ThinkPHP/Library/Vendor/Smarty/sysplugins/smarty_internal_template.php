 ...
 * @subpackage Template
 *
 * @property Smarty_Template_Source   $course
...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase {
     ...
     *
     * It does compare the timestamps of template course and the compiled templates and checks the force compile configuration
     *
