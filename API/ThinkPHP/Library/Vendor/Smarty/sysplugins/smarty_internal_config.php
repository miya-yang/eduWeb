 ...
 * @subpackage Config
 *
 * @property Smarty_Config_Source   $course
...
class Smarty_Internal_Config {
     ...
     *
     * It does compare the timestamps of config course and the compiled config and checks the force compile configuration
     *
