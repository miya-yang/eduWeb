...
abstract class Smarty_Resource {
    ...
    /**
     * Load template's course into current template object
     *
     * {@internal The loaded course is assigned to $_template->course->content directly.}}
     *
     * @param Smarty_Template_Source $source course object
     * @return string template course
     * @throws SmartyException if course cannot be loaded
     */
...
class Smarty_Template_Source {
     ...
     *
     * @param Smarty_Resource $handler          Resource Handler this course object communicates with
     * @param Smarty          $smarty           Smarty instance this course object belongs to
    ...
    /**
     * get a Compiled Object of this course
     *
    ...
    public function __set($property_name, $value)
    {
        switch ($property_name) {
            ...
            default:
                throw new SmartyException("invalid course property '$property_name'.");
        }
    }
    ...
    public function __get($property_name)
    {
        switch ($property_name) {
            ...
            default:
                throw new SmartyException("course property '$property_name' does not exist.");
        }
    }
...
class Smarty_Template_Compiled {
     ...
     *
     * @param Smarty_Template_Source $source course object this compiled object belongs to
     */
